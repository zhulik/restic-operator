...
// +kubebuilder:webhook:path=/mutate-restic-zhulik-wtf-v1-repository,mutating=true,failurePolicy=fail,sideEffects=None,groups=restic.zhulik.wtf,resources=repositories;repositories/status,verbs=create;update,versions=v1,name=mrepository-v1.kb.io,admissionReviewVersions=v1
...
func (d *RepositoryCustomDefaulter) Default(ctx context.Context, obj runtime.Object) error {
	repository, ok := obj.(*resticv1.Repository)
	if !ok {
